---
title: "Ethique des données, cadre juridique de la protection des données personnelles"
...
---
### La revue de documentaire

* Un travail en groupe de 3 ou 4 personnes, **obligatoirement mélange des deux parcours**

* Choisissez un documentaire dans la liste qui suit

* Produisez un podcast de 5 à 7 minutes pour le vendredi 20 novembre

* Uploadez votre podcast sur la plateforme de votre choix (Soundcloud par exemple)
...
* Des extraits (traduits et doublés si nécessaires), pas trop longs pour rester audible

* Un retour critique expliquant pourquoi le voir

* Un aperçu des enseignements de ce documentaire pour la compréhension des enjeux numériques de l'information 

Outils : [Audacity](https://www.audacityteam.org/), [Anchor](https://anchor.fm/), Garage Band

Attention à la qualité d'enregistrement du son et à bien égaliser les voix

---
### Les films au choix 

<iframe class="airtable-embed" src="https://airtable.com/embed/shrTYYZlbieVgVxEa?backgroundColor=gray" frameborder="0" onmousewheel="" width="100%" height="533" style="background: transparent; border: 1px solid #ccc;"></iframe>

---
class:inverse, middle

## [Inscrivez vous !](https://airtable.com/shrcPxV1MlPMLBilL)
---

class:inverse, middle, center

# Retour sur les données crowdsourcées
