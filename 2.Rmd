---
title: "Les données dans leur diversité : type, formats, modes de collecte et de circulation"
...
params:
  event: Les données dans leur diversité (type, formats, modes de collecte et de circulation)
---
...
Ces slides en ligne : https://samgoeta.github.io/spx_eni/2.html
...
.reduite[![](https://datactivist.coop/atelier-osm/img/nodes.png) ]
.footnote[CC BY-SA esambale on slideshare]

---
### Un monde de tags
.reduite[.center[![](https://datactivist.coop/atelier-osm/img/tags.png)]]
.footnote[CC BY-SA esambale on slideshare]

---
### Le principe d'un tag : KEY=VALUE
.reduite[.center[![](https://datactivist.coop/atelier-osm/img/keyvalue.png)]]
.footnote[CC BY-SA esambale on slideshare]

---
### « Elements cartographiques » : la bible des tags
.reduite[.center[[![](https://datactivist.coop/atelier-osm/img/mapfeature.png)](http://wiki.openstreetmap.org/wiki/FR:Éléments_cartographiques)]]
.footnote[http://wiki.openstreetmap.org/wiki/FR:Éléments_cartographiques]

---
### Comment cartographier un ... ? 
.reduite[.center[![comment](https://datactivist.coop/atelier-osm/img/comment.png)]]
